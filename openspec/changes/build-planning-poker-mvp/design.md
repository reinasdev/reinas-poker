...
O administrador poderá finalizar a sala a qualquer momento, inclusive com tarefas pendentes. A transição impedirá novos votos, alterações de fila e novos ingressos como participante. O resumo manterá tarefas pendentes sem resultado final e exibirá, para tarefas concluídas, votos históricos e resultado quando existente.
